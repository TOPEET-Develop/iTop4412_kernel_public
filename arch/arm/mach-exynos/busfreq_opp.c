...
static DEVICE_ATTR(curr_freq, 0755, show_level_lock, store_level_lock);
static DEVICE_ATTR(lock_list, 0755, show_locklist, NULL);
static DEVICE_ATTR(time_in_state, 0755, show_time_in_state, NULL);
