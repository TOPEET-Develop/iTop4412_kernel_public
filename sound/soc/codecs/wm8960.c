...
//cym extern bool head_mic_connect;
bool head_mic_connect = true;
...
//Apollo +
SOC_SINGLE("Left ADC Volume", WM8960_LADC, 0, 255, 0),
SOC_SINGLE("Right ADC Volume", WM8960_RADC, 0, 255, 0),
SOC_SINGLE("ADC PATH", WM8960_ADDCTL1, 2, 3, 0), 
//Aolloo -
};
...
//		snd_soc_write(codec, WM8960_POWER1, 0);
		if(head_mic_connect)
  		snd_soc_write(codec, WM8960_POWER1, 0x02);
		else
		  snd_soc_write(codec, WM8960_POWER1, 0);
//Apollo -
		msleep(600);
...
//Apollo +
	...
	reg = snd_soc_read(codec, WM8960_ALC1);
	snd_soc_write(codec, WM8960_ALC1, reg | 0x180);

	if(head_mic_connect)
	{
  	reg = snd_soc_read(codec, WM8960_POWER1);
  	snd_soc_write(codec, WM8960_POWER1, reg | 0x02);
  }
//Apollo -
